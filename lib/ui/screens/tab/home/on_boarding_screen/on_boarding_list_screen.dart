...
import 'package:digitifyze/ui/screens/tab/home/on_boarding_screen/add_on_boarding_screen/add_on_boarding_screen.dart';
import 'package:digitifyze/ui/screens/tab/home/on_boarding_screen/on_boarding_detail/on_boarding_detail_screen.dart';
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    if (controller().getOnboardingDataList.isEmpty) ...[
                      Container(
                          height: 525.h,
                              ...
                              Flexible(
                                child: Container(
                                  ...
                                  child: ListView.builder(
                                    itemCount: controller().getOnboardingDataList.length,
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) {
                                      var item =
                                      controller().getOnboardingDataList[index];
