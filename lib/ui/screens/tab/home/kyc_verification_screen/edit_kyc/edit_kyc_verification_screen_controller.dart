...
part 'edit_kyc_verification_screen_controller.g.dart';

@riverpod
class EditKycVerificationScreenController
    extends _$EditKycVerificationScreenController {
  ...
  bool _isUpdateKycLoading = false;
  bool get isUpdateKycLoading => _isUpdateKycLoading;
  ...
  checkValidateGeneralInfo() {
    ...
    if (globalKycDetailModel.isAadharNoMandatory! && validateAadhaar(aadharNoController.text.trim()) != null) {
      return;
    }

    if (globalKycDetailModel.isPancardNoMandatory! && validatePanNo(panNoController.text.trim()) != null) {
      return;
    }
    if (globalKycDetailModel.isCurrentAddressMandatory! && validateAddress(currentAddressController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isPermanentMandatory! && validateAddress(permanentAddressController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isPancardNoMandatory! && panNoController.text.isEmpty) {
      return;
    }
    ...
    if (globalKycDetailModel.isDriverPicMandatory! && userUrl == "" && userPicFile == null) {
      return;
    }

    if (globalKycDetailModel.isAadharPicMandatory! && frontAadharUrl == "" && frontAadharPicFile == null) {
      return;
    }
    if (globalKycDetailModel.isAadharPicMandatory! && backAadharUrl == "" && backAadharPicFile == null) {
      return;
    }
    if (globalKycDetailModel.isPancardPicMandatory! && panCardUrl == "" && panCardPicFile == null) {
      return;
    }
  ...
  checkValidateVehicleInfo() {
    ...
    //   return;
    // }
    if (globalKycDetailModel.isDlNoMandatory! && validateDlNo(dlNoController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isRcNoMandatory! && validateRcNo(rcNoController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isRegistrationDateMandatory! && validateDropDown(registrationDateController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isVehicleAgeMandatory! && validateDropDown(vehicleAgeController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isLatitudeMandatory! && validateDropDown(latitudeNoController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isLongitudeMandatory! && validateDropDown(longitudeNoController.text) != null) {
      return;
    }
    ...
    if (globalKycDetailModel.isDlPicMandatory! && dlUrl == "" && dlPicFile == null) {
      return;
    }
    if (globalKycDetailModel.isRcPicMandatory! && rcUrl == "" && rcPicFile == null) {
      return;
    }
    if (globalKycDetailModel.isNocDocumentationMandatory! && nocUrl == "" && nocPicFile == null) {
      return;
    }
  ...
  checkValidateBankInfo() {
    ...
    if (globalKycDetailModel.isAccountNoMandatory! && validateDropDown(accountNoController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isIfscCodeMandatory! && validateIFSCCode(ifscCodeController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isDlNoMandatory! && validateDropDown(dlNoController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isReference1NameMandatory! && validateDropDown(firstReferenceNameController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isReference1MobileMandatory! && validatePhone(firstReferenceMobileNoController.text.trim()) != null) {
      return;
    }
    if (globalKycDetailModel.isReference2NameMandatory! && validateDropDown(secondReferenceNameController.text) != null) {
      return;
    }
    if (globalKycDetailModel.isReference2MobileMandatory! && validatePhone(secondReferenceMobileNoController.text.trim()) != null) {
      return;
    }
    if (globalKycDetailModel.isCibilScoreMandatory! && validateDropDown(cibilScoreController.text) != null) {
      return;
    }
    ...
    if (globalKycDetailModel.isBankChequePicMandatory! && bankChequeUrl == "" && bankChequePicFile == null) {
      return;
    }
    if (globalKycDetailModel.isElectricityBillMandatory! && billUrl == "" && billPicFile == null) {
      return;
    }
    if (globalKycDetailModel.isSelfieWithDriverPicMandatory! && selfieList.isEmpty) {
      return;
    }
  ...
  void startUpdateKycLoading() {
    state = const AsyncLoading();
    _isUpdateKycLoading = true;
    state = const AsyncValue.data(null);
  }

  void stopUpdateKycLoading() {
    state = const AsyncLoading();
    _isUpdateKycLoading = false;
    state = const AsyncValue.data(null);
  }


  Future<void> insertLeadKyc() async {
    startUpdateKycLoading();
    ...
    try{
      ...
      if (backAadharPicFile != null) {
        uploadFileList.add(await renameFile(backAadharPicFile!, 'AadharBackPic'));
      ...
      if (selfieList.length > 1 && selfieList[1]['file'] != null) {
        uploadFileList.add(await renameFile(selfieList[1]['file'], "DriverPic1"));
        uploadFileParam.add('driverpic1');
      }
      if (selfieList.length > 2 && selfieList[2]['file'] != null) {
        uploadFileList.add(await renameFile(selfieList[2]['file'], "DriverPic2"));
        uploadFileParam.add('driverpic2');
      }
      if (selfieList.length > 3 && selfieList[3]['file'] != null) {
        uploadFileList.add(await renameFile(selfieList[3]['file'], "DriverPic3"));
        uploadFileParam.add('driverpic3');
      }
      if (selfieList.length > 4 && selfieList[4]['file'] != null) {
        uploadFileList.add(await renameFile(selfieList[4]['file'], "DriverPic4"));
        uploadFileParam.add('driverpic4');
      }
      if (selfieList.length > 5 && selfieList[5]['file'] != null) {
        uploadFileList.add(await renameFile(selfieList[5]['file'], "DriverPic5"));
      ...
      KycLeadRequest kycLeadRequest = KycLeadRequest(
        ...
        userPic: userPicFile != null ? "" : userUrl,
        aadharFrontPic: frontAadharPicFile != null ? "" : frontAadharUrl,
        aadharBackPic: backAadharPicFile != null ? "" : backAadharUrl,
        panCardPic: panCardPicFile != null ? "" : panCardUrl,
        nocDocument: nocPicFile != null ? "" : nocUrl,
        dlPic: dlPicFile != null ? "" : dlUrl,
        rcPic: rcPicFile != null ? "" : rcUrl,
        blanckCheckPic: bankChequePicFile != null ? "" : bankChequeUrl,
        selfieWithDriver:
        selfieList[0]['file'] != null ? "" : selfieList[0]['url'],
        driverPic1: selfieList.length > 1
            ? selfieList[1]['file'] != null
            ? ""
            : selfieList[1]['url']
            : "",
        driverPic2: selfieList.length > 2
            ? selfieList[2]['file'] != null
            ? ""
            : selfieList[2]['url']
            : "",
        driverPic3: selfieList.length > 3
            ? selfieList[3]['file'] != null
            ? ""
            : selfieList[3]['url']
            : "",
        driverPic4: selfieList.length > 4
            ? selfieList[4]['file'] != null
            ? ""
            : selfieList[4]['url']
            : "",
        driverPic5: selfieList.length > 5
            ? selfieList[5]['file'] != null
            ? ""
            : selfieList[5]['url']
            : "",
        ownershipPic: billPicFile != null ? "" : billUrl,
        entryBy: 1,
